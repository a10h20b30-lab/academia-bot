...
const CANDIDATE_STEPS = [
  ...
  { key: "interests",           question: "באיזה תחום את/ה מחפש/ת עבודה?\nאפשר לסמן כמה ולחץ סיום ✓",                        type: "multi",  options: [["ייעוץ פרלמנטרי", "דוברות"], ["סושיאל ורשתות חברתיות", "יועץ פוליטי"], ["עריכת וידאו", "עיצוב גרפי"], ["תחקיר", "עריכה"], ["ניהול לשכה", "סיום ✓"]] },
...
const EMPLOYER_STEPS = [
  { key: "org_type",              question: "מטעם מי אתם פונים?",                                                               type: "single", options: [["כנסת", "עירייה"], ["משרד יח\"צ / סושיאל", "ערוץ תקשורת"], ["אחר"]] },
