  ...
  for (const candidate of candidates) {
    ...
    if (notifyCandidates) {
      ...
      const orgMsg =
        ...
        orgType === "לשכת שר"                 ? "לשכת שר חדשה הצטרפה לקוזו ונראה שאתם מתאימים — העברנו את הפרטים שלך. במידה וזה יהיה רלוונטי, ייצרו איתך קשר 🤝"  :
        orgType === "משרד ממשלתי"             ? "משרד ממשלתי חדש הצטרף לקוזו ונראה שאתם מתאימים — העברנו את הפרטים שלך. במידה וזה יהיה רלוונטי, ייצרו איתך קשר 🤝":
        orgType === "ערוץ תקשורת"             ? "ערוץ תקשורת חדש הצטרף לקוזו ונראה שאתם מתאימים — העברנו את הפרטים שלך. במידה וזה יהיה רלוונטי, ייצרו איתך קשר 🤝":
...
const CANDIDATE_STEPS = [
  { key: "full_name",           question: "שמך המלא?",                                                                          type: "text"   },
  { key: "email",               question: "כתובת מייל?",                                                                        type: "email"  },
  { key: "city",                question: "עיר מגורים?",                                                                        type: "text"   },
  { key: "degree",              question: "האם יש לך תואר אקדמי?",                                                              type: "single", options: [["תואר ראשון", "תואר שני"], ["אין תואר"]] },
  { key: "field_of_study",      question: "תחום הלימודים?",                                                                     type: "text",   conditional: "degree!=אין תואר" },
  ...
  { key: "interests",           question: "באיזה תחום את/ה מחפש/ת עבודה?\nאפשר לסמן כמה ולחץ סיום ✓",                        type: "multi",  options: [["ייעוץ פרלמנטרי", "דוברות"], ["סושיאל ורשתות חברתיות", "יועץ פוליטי"], ["עריכת וידאו", "עיצוב גרפי"], ["תחקיר", "עריכה"], ["יועץ לשכת שר", "יועץ משרד ממשלתי"], ["ניהול לשכה", "סיום ✓"]] },
  { key: "workplace_pref",      question: "היכן תרצה/י לעבוד?",                                                                type: "single", options: [["כנסת", "עירייה"], ["שניהם"]] },
  { key: "timing",              question: "מתי תוכל/י להתחיל?",                                                                type: "single", options: [["מיידי", "בחודש הקרוב"], ["גמיש / פתוח"]] },
  { key: "availability",        question: "היקף המשרה המבוקש?",                                                                type: "single", options: [["משרה מלאה", "משרה חלקית"], ["פרילנס", "פתוח לכל הצעה"]] },
  { key: "cv",                  question: "קורות חיים 📎\nגם אם לא מושלמים — שלח מה שיש.",                                    type: "file"   },
  { key: "motivation",          question: "מה מביא/ה אותך לקוזו?",                                                             type: "text"   },
  { key: "has_references",      question: "האם יש לך ממליצים?",                                                                type: "single", options: [["כן ✅", "לא ❌"]] },
  { key: "references",          question: "שם ונייד הממליצים — אפשר כמה, שורה לכל אחד",                                       type: "text",   conditional: "has_references=כן ✅" },
  { key: "political_side",      question: "עם איזה צד פוליטי תרצה/י לעבוד?",                                                  type: "single", options: [["קואליציה", "אופוזיציה"], ["שניהם"]] },
  { key: "has_license",         question: "האם יש לך רישיון נהיגה?",                                                          type: "single", options: [["כן", "לא"]] },
  { key: "availability_status", question: "מה סטטוס החיפוש שלך כרגע?",                                                        type: "single", options: [["🟢 מחפש באופן פעיל", "🟡 פתוח להצעות"], ["⚪ לא מחפש כרגע"]] },
  { key: "declaration",         question: "רק לידיעה. הפרטים ישמשו אותי להתאמות בלבד. אין בזה התחייבות מאף צד 🤝",          type: "single", options: [["מאשר ✅"]] },
];

const EMPLOYER_STEPS = [
  { key: "org_type",              question: "מטעם מי אתם פונים?",                                                               type: "single", options: [["כנסת", "עירייה"], ["משרד יח\"צ / סושיאל", "ערוץ תקשורת"], ["לשכת שר", "משרד ממשלתי"], ["אחר"]] },
  { key: "contact_name",          question: "שם ותפקיד?",                                                                       type: "text"   },
  { key: "email",                 question: "כתובת מייל?",                                                                      type: "email"  },
  { key: "fields",                question: "מה התחום שאתם מחפשים?\nאפשר לסמן כמה ולחץ סיום ✓",                               type: "multi",  options: [["ייעוץ פרלמנטרי", "דוברות"], ["סושיאל ורשתות חברתיות", "יועץ פוליטי"], ["עריכת וידאו", "עיצוב גרפי"], ["תחקיר", "עריכה"], ["יועץ לשכת שר", "יועץ משרד ממשלתי"], ["ניהול לשכה", "סיום ✓"]] },
  ...
  { key: "experience_importance", question: "מה חשיבות הניסיון הפרלמנטרי?",                                                    type: "single", options: [["חובה מוחלטת", "יתרון משמעותי"], ["לא הכרחי"]] },
